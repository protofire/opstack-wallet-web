        ...
        <form onSubmit={formMethods.handleSubmit(handleSubmit)} className={commonCss.form}>
          ...
          <TxCard>
            <FormControlLabel
              ...
              label="I understand that the Recoverer will be able to initiate recovery of this Safe Account and that I will only be informed within the Superchain Safe."
