...
export const ImportFileUpload = ({
  ...
  return (
    <>
      <Typography>Import {'Superchain Safe'} data by uploading a file in the area below.</Typography>
      ...
      <Typography>
        ...
        />
        Only JSON files exported from the {'Superchain Safe'} can be imported.
      </Typography>
    </>
  )
}
