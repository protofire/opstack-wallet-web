  ...
  return (
    <div>
      ...
      <ol start={1}>
        ...
        <li>
          &ldquo;{'Superchain Safe'}&rdquo; refers to a web-based graphical user interface for Safe Accounts as well as
      ...
      <p>
        When visiting our website or using {'Superchain Safe'}, we may collect and process personal data. The data will
      ...
      <p>
        We enable the user to unlock the {'Superchain Safe'} mobile app via biometrics information (touch ID or face
