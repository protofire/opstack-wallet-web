...
const SafePrivacyPolicy = () => (
  <SmoothScroll>
    ...
    <ol>
      ...
      <li>
        &ldquo;{'Superchain Safe'}&rdquo; refers to a web-based graphical user interface for Safe Accounts as well as a
    ...
    <h4>4.1. When visiting our website and using {'Superchain Safe'}</h4>
    <p>
      When visiting our website or using {'Superchain Safe'}, we may collect and process personal data. The data will be
    ...
    <ol start={4}>
      <li>
        ...
        the {'Superchain Safe'}, we process your
        <ol>
    ...
    <p>
      In addition, we may take a recording of you while testing {'Superchain Safe'} for internal and external use. The
    ...
    <p>
      {'Superchain Safe'} mobile apps are distributed via{' '}
    ...
    <p>
      We enable the user to unlock the {'Superchain Safe'} mobile app via biometrics information (touch ID or face ID).
    ...
    <p>
      ...
      different decentralized applications and our app and to enhance your experience with {`Superchain Safe`}. For
...
const PrivacyPolicy: NextPage = () => {
  return (
    <>
      <Head>
        <title>{'Superchain Safe – Privacy policy'}</title>
      </Head>
