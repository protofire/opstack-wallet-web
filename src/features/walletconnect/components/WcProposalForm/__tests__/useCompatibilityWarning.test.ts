  ...
  describe('should return an error for a dangerous bridge', () => {
    it('if the dApp is named', () => {
      ...
      expect(result.current).toEqual({
        message:
          'Fake Bridge is a bridge that is incompatible with Superchain Safe — the bridged funds will be lost. Consider using a different bridge.',
        severity: 'error',
      })
    })
    ...
    it('if the dApp is not named', () => {
      ...
      expect(result.current).toEqual({
        message:
          'This dApp is a bridge that is incompatible with Superchain Safe — the bridged funds will be lost. Consider using a different bridge.',
        severity: 'error',
      })
    })
  })
