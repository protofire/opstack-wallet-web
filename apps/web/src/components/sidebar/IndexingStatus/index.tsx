...
const STATUS_PAGE = IS_PRODUCTION
  ? 'https://tx-status-app.safe.protofire.io/?serviceUrl=https://gateway.safe.optimism.io'
  : 'https://tx-status-app.safe.protofire.io/?serviceUrl=https://gateway.superchain.stage.safe.protofire.io'
